...
from app.services.experimental_direction_model import build_direction_model  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--history-manifest", type=Path, help="D+1/D+2/D+5: attested static-history manifest")
    ...
    if args.prediction_kind == "net_h5":
        if args.source is None or args.history_manifest is not None or args.database is not None:
        ...
        if args.source is not None or args.history_manifest is None or args.database is None:
            parser.error("close_d1/close_d2/close_d5 require --history-manifest and --database, not H5 --source")
